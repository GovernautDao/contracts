...
contract MyScript is Script {
    ...
    function run() external {
        ...
        address governancetoken = helperConfig.getMetalL2TestnetConfig()._governanceTokenForThatChain;
        ...
        governance = new GovernautGovernance(IVotes(governancetoken), address(identitymanager));
        funding = new Funding(vm.addr(deployerPrivateKey), address(governance), governancetoken);
        vm.stopBroadcast();
    }
}
