...
contract WorldIDIdentityManagerRouterMock is IWorldIDGroups {
  ...
  /**
   * @notice this is only for testing other contracts
   * @dev completely dumb
   * @dev not given by worldcoin, custom added by devs of this protocol
   */
  function dumbVerifyProof() public pure returns (bool) {
    return true;
  }
}
